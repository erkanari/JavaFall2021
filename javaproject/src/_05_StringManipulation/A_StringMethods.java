...
public class A_StringMethods {
    public static void main(String[] args) {
        ...
        /** lastindexOf()
         *  String içinde aranan karakter(ler)in sondan itibaren ilk indexini varir
         *  indexOf un sondan olan hali fakat index numaralari deðiþmez.
         */
         ...
         * karakterlerin sirasi 0 dan baþlar, buna index denir.
        ...
        /** ReplaceFirst
        * Replace ile ayni sadece ilk bulunani deðiþtirir
         */
         ...
         * bir stringin içerisinde karakter(ler)in var olup olmadiðini kontrol eder.
         * Sonuc boolean dir.
         *
         * equals()
         * 2 String metnin birbirine esit olup olmadigina bakar. büyük küçük harf farki vardir. Sonuc boolean dir.
         *
         * equalsignorecase()
